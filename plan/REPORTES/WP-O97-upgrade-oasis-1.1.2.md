...
- **Resultado**: **local completo y verificado; deploy en el VPS pendiente de GO del custodio** (ver §Deploy).
...
| pub y HUB healthy con la imagen nueva, feed ids sin cambios, `pub:invite`, MISS→HIT en el VPS, directorio verde, journal | ⏳ **deploy pendiente** (ver abajo) |
...
Resultado del deploy: <pendiente>.
